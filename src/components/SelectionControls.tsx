...
export const SelectionControls = ({ results, totalCount, searchQuery }: SelectionControlsProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Extract Details Button - Prominent and Separate */}
      {selectedCount > 0 && (
        <div className="flex justify-center">
          <Button 
            ...
            size="lg"
            className="flex items-center gap-3 px-8 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
          >
